...
var ElDraggable = function () {
    function ElDraggable(el, config) {
        var _this2 = this;

        classCallCheck(this, ElDraggable);
        ...
        this.conf = {
            ...
            overflow: true,
            updatePosition: function updatePosition(e, p) {
        ...
        this.mouseMove = throttle_1(function (e) {
            var border = _this2.border;

            var offsetY = e.clientY - status.clientY;
            var offsetX = e.clientX - status.clientX;
            // _this.updateBorder.call(_this)
            status.clientX = e.clientX;
            status.clientY = e.clientY;
            var left = style.left + offsetX;
            var top = style.top + offsetY;
            if (!conf.overflow) {
        ...
        this.handler.addEventListener('mousedown', function (e) {
            _this2.cacheMargin();
            var initPosition = _this2.getPosition(el.offsetParent, el, _this2.margin);
            ...
            style = initPosition;
            document.addEventListener('mousemove', _this2.mouseMove);
        ...
        document.addEventListener('mouseup', function (e) {
            if (status.dragging) {
                document.removeEventListener('mousemove', _this2.mouseMove);
    ...
    createClass(ElDraggable, [{
        key: 'updateBorder',
        value: function updateBorder() {
            var size = this.size;
            var _conf = this.conf,
                containment = _conf.containment,
                el = _conf.el;

            var offsetParent = el.offsetParent;
            var containmentPosition = containment.getBoundingClientRect();
            var offsetParentPosition = offsetParent.getBoundingClientRect();
            var margin = this.getMargin(el);
        ...
        key: 'getPosition',
        value: function getPosition(containment, el, margin) {
            var containmentPosition = containment.getBoundingClientRect();
